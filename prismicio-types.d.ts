...
export interface SettingsDocumentDataNavItemItem {
  ...
  /**
   * Item Label field in *Settings → Nav Item*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: settings.nav_item[].item_label
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
...
export interface ContentIndexSliceDefaultPrimary {
  ...
  /**
   * View More Link field in *ContentIndex → Default → Primary*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: content_index.default.primary.view_more_link
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
...
/**
 * Item in *TechList → Default → Primary → Tech Stack*
 */
export interface TechListSliceDefaultPrimaryTechStackItem {
  /**
   * Stack Name field in *TechList → Default → Primary → Tech Stack*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: tech_list.default.primary.tech_stack[].stack_name
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  stack_name: prismic.KeyTextField;

  /**
   * Stack Color field in *TechList → Default → Primary → Tech Stack*
   *
   * - **Field Type**: Color
   * - **Placeholder**: *None*
   * - **API ID Path**: tech_list.default.primary.tech_stack[].stack_color
   * - **Documentation**: https://prismic.io/docs/field#color
   */
  stack_color: prismic.ColorField;
}
...
export interface TechListSliceDefaultPrimary {
  ...
  /**
   * Tech Stack field in *TechList → Default → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: tech_list.default.primary.tech_stack[]
   * - **Documentation**: https://prismic.io/docs/field#group
   */
