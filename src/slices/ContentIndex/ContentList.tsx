...
import { asImageSrc, asLink, isFilled } from "@prismicio/client";
...
export default function ContentList({
  ...
  // const linkURL = typeof viewMoreLink === 'string' ? viewMoreLink : viewMoreLink?.url;
      ...
      >
        {items.map((post, index) => (
          ...
          >
            <PrismicLink
              href={
                "project_link" in post.data
                  ? (asLink(
                      (post.data as Content.ProjectDocumentData).project_link,
                    ) ?? "#")
                  : "#"
              }
              target='_blank'
